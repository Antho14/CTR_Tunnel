...
//----------------------------Lecture Seuil Capteur------------------------------------------------------------------------------------------
        private void buttonSeuilCO2_Click(object sender, EventArgs e)
        {
            String seuilCO = C_BDD.GetSeuilCO2();
            labelCO2.Text = seuilCO;
        }
        private void boutonSeuilFU_Click(object sender, EventArgs e)
        {
            String seuilFU = C_BDD.GetSeuilFUMEE();
            labelFUMEE.Text = seuilFU;
        }
        private void boutonSeuilLU_Click(object sender, EventArgs e)
        {
            String seuilLU = C_BDD.GetSeuilFUMEE();
            labelLUM.Text = seuilLU;
        }
